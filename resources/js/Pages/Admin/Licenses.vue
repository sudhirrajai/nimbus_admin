...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Oversee and manage all issued VMCORE licenses.</p>
                </div>
                <button 
            ...
            <div class="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-sm">
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-900 border-b border-gray-700 text-gray-400">
                        ...
                        <tbody class="divide-y divide-gray-700/80">
                            <tr v-for="license in licenses" :key="license.id" class="hover:bg-gray-900/40 transition-colors">
                                ...
                                <td class="px-6 py-4.5">
                                    ...
                                    <div v-if="license.admin_email" class="text-xs text-gray-400 mt-0.5">{{ license.admin_email }}</div>
                                    <div v-if="!license.admin_name && !license.admin_email" class="text-xs text-gray-500 italic">No admin registered</div>
                                </td>
                                <td class="px-6 py-4.5">
                                ...
                                <td class="px-6 py-4.5 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <button 
                                            ...
                                            class="text-gray-400 hover:text-rose-400 hover:bg-rose-500/5 p-1.5 rounded transition-colors"
        ...
        <div v-if="editingLicense" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div class="bg-gray-800 border border-gray-700 rounded-lg p-8 w-full max-w-md shadow-2xl animate-fade-in relative text-gray-100">
                <div class="flex items-center justify-between pb-4 border-b border-gray-700 mb-6">
                    ...
                    <button @click="editingLicense = null" class="text-gray-400 hover:text-gray-200">
        ...
        <div v-if="generatingLicense" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div class="bg-gray-800 border border-gray-700 rounded-lg p-8 w-full max-w-md shadow-2xl animate-fade-in relative text-gray-100">
                <div class="flex items-center justify-between pb-4 border-b border-gray-700 mb-6">
                    ...
                    <button @click="generatingLicense = false; generateForm.reset()" class="text-gray-400 hover:text-gray-200">
                        <span class="material-symbols-rounded text-sm">close</span>
                    </button>
                </div>
