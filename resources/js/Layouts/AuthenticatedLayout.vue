...
<template>
    <div class="min-h-screen bg-gray-900 text-gray-100 selection:bg-gray-800 font-sans">
        ...
        <div v-if="showingNavigationDropdown" class="fixed inset-0 z-50 flex md:hidden" role="dialog" aria-modal="true">
            ...
            <!-- Drawer Container -->
            <div class="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800 border-r border-gray-700 pt-5 pb-4 animate-slide-in">
                <!-- Close Button -->
        ...
        <div class="md:pl-64 flex flex-col flex-1">
            <header class="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between border-b border-gray-700 bg-gray-800/80 backdrop-blur-md px-6">
                <!-- Left: Hamburger + Breadcrumbs -->
                <div class="flex items-center gap-4">
                    <button @click="showingNavigationDropdown = true" class="inline-flex items-center justify-center rounded-lg p-2 text-gray-400 hover:bg-gray-700/40 md:hidden outline-none">
                        <span class="material-symbols-rounded">menu</span>
                    </button>

                    <!-- Breadcrumbs -->
                    <nav class="hidden sm:flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-gray-500">
                        <span class="text-gray-400">{{ $page.props.auth.user.is_admin && route().current('admin.*') ? 'Admin' : 'App' }}</span>
                ...
                <div class="flex items-center gap-4">
                    <Dropdown align="right" width="48">
                        ...
                        <template #content>
                            <div class="p-1 bg-gray-800 border border-gray-700 rounded-lg shadow-lg">
                                <DropdownLink :href="route('profile.edit')" class="rounded-md hover:bg-gray-700/60 text-gray-300"> 
            ...
            <div v-if="$slots.header" class="border-b border-gray-700/50 bg-gray-900 py-6 px-6 lg:px-8">
            ...
            <main class="flex-1 py-8 px-6 lg:px-8 bg-gray-900">
                <div class="mx-auto max-w-7xl">
                    <slot />
                </div>
            </main>
            ...
            <!-- Footer -->
            <footer class="border-t border-gray-700 py-6 px-6 lg:px-8 bg-gray-900/30">
